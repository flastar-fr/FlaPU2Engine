...
std::vector<Token> VALID_OPERANDS_3_REGISTER_1_REGISTER_REGISTER_VALUES_CLASSIC = {Token(REGISTER_RESULT, ValueType::REGISTER),
    Token(FIRST_REGISTER_TO_USE, ValueType::REGISTER_VALUE),
    Token(SECOND_REGISTER_TO_USE, ValueType::REGISTER_VALUE)};
std::vector<Token> VALID_OPERANDS_3_REGISTER_VALUES_CLASSIC = {Token(FIRST_REGISTER_TO_USE, ValueType::REGISTER_VALUE),
    Token(SECOND_REGISTER_TO_USE, ValueType::REGISTER_VALUE),
