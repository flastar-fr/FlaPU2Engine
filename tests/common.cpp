...
std::vector<Token> VALID_OPERANDS_2_FLAG_IMM_CLASSIC_EQUALS = {Token(FIRST_FLAG, ValueType::FLAG), Token(ALTERNATIVE_TEST_VALUE, ValueType::IMMEDIATE_VALUE)};
std::vector<Token> VALID_OPERANDS_2_FLAG_IMM_CLASSIC_NOT_EQUALS = {Token(SECOND_FLAG, ValueType::FLAG), Token(ALTERNATIVE_TEST_VALUE, ValueType::IMMEDIATE_VALUE)};
std::vector<Token> VALID_OPERANDS_2_FLAG_IMM_CLASSIC_GREATER_EQUALS = {Token(THIRD_FLAG, ValueType::FLAG), Token(ALTERNATIVE_TEST_VALUE, ValueType::IMMEDIATE_VALUE)};
std::vector<Token> VALID_OPERANDS_2_FLAG_IMM_CLASSIC_LESS = {Token(FOURTH_FLAG, ValueType::FLAG), Token(ALTERNATIVE_TEST_VALUE, ValueType::IMMEDIATE_VALUE)};

std::vector<Token> VALID_OPERANDS_2_REGISTER_REGISTER_VALUE_CLASSIC = {Token(FIRST_REGISTER_TO_USE, ValueType::REGISTER), Token(SECOND_REGISTER_TO_USE, ValueType::REGISTER_VALUE)};
std::vector<Token> VALID_OPERANDS_3_REGISTER_REGISTER_VALUE_IMM_CLASSIC = {Token(FIRST_REGISTER_TO_USE, ValueType::REGISTER), Token(SECOND_REGISTER_TO_USE, ValueType::REGISTER_VALUE), Token(ALTERNATIVE_TEST_VALUE, ValueType::IMMEDIATE_VALUE)};